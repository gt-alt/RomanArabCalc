public class notGoodCalc
{
    public notGoodCalc(String value1, String value2, String oper)
    {
        a = value1;
        b = value2;
    ...
    private static int identifyNumOperation(String operator)
    {
        int oper = 0;
        if (operator == "*") oper = 1; //-->    *
        else if (operator == "/") oper = 2; //-->    /
        else if (operator == "+") oper = 3; //-->   +
        else if (operator == "-") oper = 4; //-->   -
        try
        {
